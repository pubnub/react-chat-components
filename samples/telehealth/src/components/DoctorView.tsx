...
function DoctorView(props: DoctorViewProps): JSX.Element {
  ...
  return (
    <div className="doctor-view flex grow justify-end overflow-hidden rounded-xl shadow-xl">
      <Chat currentChannel={channel} users={[patient, doctor]}>
        ...
        <section className="flex flex-col grow">
          <header className="flex items-center h-[70px] pl-4 bg-cyan-500 dark:bg-slate-500 dark:text-white text-gray-800">
