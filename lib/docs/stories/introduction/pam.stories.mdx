...
PubNub Access Manager (PAM) allows you to enforce security controls for client access to resources
within the PubNub network. With PAM, your servers can grant their clients access to individual
PubNub resources for a limited duration, with the ability to renew access or add permissions for
...
<!--To be reviewed by @pnehrer in https://github.com/pubnub/platform-documentation/pull/569-->
