...
metadata about the entities. See the reference below to understand what's expected where and
why:
...
to the components using our custom [React hooks](https://pubnub.github.io/react-chat-components/docs/?path=/docs/custom-hooks-about--page).
