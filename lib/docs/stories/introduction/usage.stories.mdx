...
### (Alternative) Add the components to a React app
...
- [Sample apps](https://pubnub.github.io/react-chat-components/samples) to see what you can do with PubNub Chat Components for React. 
- [Chat Provider](https://pubnub.github.io/react-chat-components/docs/?path=/docs/components-chat-provider--default)
and the rest of the components to see what customizations options can help you make the app truly yours.
