...
For both paths, you will need an account on our [Admin Portal](https://dashboard.pubnub.com/).
...
<Tabs>
<Tab label="Download and run the starter app">
...
<Tab label="Use pre-existing or create a new app">
...
To expand your app further, check out:

- [Sample apps](https://pubnub.github.io/react-chat-components/samples) to see what you can do with
...
- [Chat Provider](https://pubnub.github.io/react-chat-components/docs/?path=/docs/components-chat-provider--default)
  and the rest of the components to see what customizations options can help you make the app truly
  yours.
