...
1. Open the `App.js` file in a code editor and import PubNub providers from the [Javascript SDK](https://www.pubnub.com/docs/sdks/javascript/api-reference/configuration#initialization) and [React SDK](https://www.pubnub.com/docs/sdks/javascript/react/api-reference/provider). 
