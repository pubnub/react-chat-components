    ...
    if (targets === null || targets === void 0 ? void 0 : targets.outputs) {
        return targets.outputs
            ...
            const interpolated = interpolate(output, {
                ...
                project: Object.assign(Object.assign({}, node.data), { name: node.data.name }),
                options,
            });
