...
exports.commandsObject = yargs
    ...
    handler: (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () {
        return (yield Promise.resolve().then(() => require('./affected'))).affected('print-affected', withOverrides(args));
    }),
})
    .command({
    command: 'daemon',
...
- Run migrations (e.g., nx migrate --run-migrations=migrations.json)`,
    ...
    .command('repair', 'Repair any configuration that is no longer supported by Nx.', (yargs) => linkToNxDevAndExamples(yargs, 'repair').option('verbose', {
    type: 'boolean',
    describe: 'Prints additional information about the commands (e.g., stack traces)',
}), (args) => tslib_1.__awaiter(void 0, void 0, void 0, function* () { return process.exit(yield (yield Promise.resolve().then(() => require('./repair'))).repair(args)); }))
    .help()
...
function withOverrides(args) {
    ...
    if (split > -1) {
        ...
        delete args._;
        return Object.assign(Object.assign({}, args), { __overrides__: overrides });
    }
    else {
