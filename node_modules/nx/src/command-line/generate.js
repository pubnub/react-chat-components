...
function newWorkspace(cwd, args) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return (0, params_1.handleErrors)(false, () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const combinedOpts = yield (0, params_1.combineOptionsForGenerator)(opts.generatorOptions, opts.collectionName, normalizedGeneratorName, null, schema, opts.interactive, null, null, false);
            if (ws.isNxGenerator(opts.collectionName, normalizedGeneratorName)) {
                ...
                return (yield Promise.resolve().then(() => require('../adapter/ngcli-adapter'))).generate(cwd, Object.assign(Object.assign({}, opts), { generatorOptions: combinedOpts }), false);
            }
        }));
    });
}
