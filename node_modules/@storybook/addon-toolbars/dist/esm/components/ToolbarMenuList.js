...
export var ToolbarMenuList = withKeyboardCycle(function (_ref) {
  ...
  if (showName && !title) {
    ...
    title = name;
    console.warn("Using the `name` \"".concat(name, "\" as toolbar title for backward compatibility. `name` will stop having dual purposes in the future. Please specify either a `title` or an `icon` in `globalTypes` instead."));
  }
