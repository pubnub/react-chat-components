...
function toInternalOptions(options) {
    ...
    const typescript = (_a = options.typescript) !== null && _a !== void 0 ? _a : ts__default.default;
    return {
        ...options,
        typescript,
        factory: compatfactory.ensureNodeFactory((_b = options.factory) !== null && _b !== void 0 ? _b : typescript),
        ...
        preserveComments: (_f = options.preserveComments) !== null && _f !== void 0 ? _f : true,
        commentRanges: new Set(),
        debug: (_g = options.debug) !== null && _g !== void 0 ? _g : false,
        depth: 0,
        hook: (_h = options.hook) !== null && _h !== void 0 ? _h : (() => ({})),
        finalize: (_j = options.finalize) !== null && _j !== void 0 ? _j : (() => {
            // Noop
        })
    };
}
...
function toSetParentNodesOptions(options) {
    var _a, _b, _c;
    return {
        typescript: (_a = options.typescript) !== null && _a !== void 0 ? _a : ts__default.default,
...
function nextNode(node, options) {
    ...
    const visitorOptions = {
        ...options,
        nextNode: (actualNode) => nextNode(actualNode, nextOptions(options)),
        nextNodes: ((actualNodes) => nextNodes(actualNodes, nextOptions(options))),
...
function executeCloneNode(node, options) {
    ...
    else if ((_p = (_o = options.typescript).isAssertClause) === null || _p === void 0 ? void 0 : _p.call(_o, node)) {
        return cloneAssertClause(node, options);
    }
    // Note: isAssertEntry may not be supported by the provided TypeScript version, so the invocation is optional.
    else if ((_r = (_q = options.typescript).isAssertEntry) === null || _r === void 0 ? void 0 : _r.call(_q, node)) {
        return cloneAssertEntry(node, options);
    } // Note: isAssertEntry may not be supported by the provided TypeScript version, so the invocation is optional.
    else if (isImportTypeAssertionContainer(node, options.typescript)) {
        return cloneImportTypeAssertionContainer(node, options);
    }
