...
export declare type RestEndpointMethods = {
    ...
    orgs: {
         ...
         */
        deleteCustomRole: {
            (params?: RestEndpointMethodTypes["orgs"]["deleteCustomRole"]["parameters"]): Promise<RestEndpointMethodTypes["orgs"]["deleteCustomRole"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
         ...
         */
        updateCustomRole: {
            (params?: RestEndpointMethodTypes["orgs"]["updateCustomRole"]["parameters"]): Promise<RestEndpointMethodTypes["orgs"]["updateCustomRole"]["response"]>;
            defaults: RequestInterface["defaults"];
            endpoint: EndpointInterface<{
                url: string;
            }>;
