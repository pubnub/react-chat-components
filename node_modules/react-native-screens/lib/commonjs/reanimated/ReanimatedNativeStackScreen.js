...
const AnimatedScreen = _reactNativeReanimated.default.createAnimatedComponent(_reactNativeScreens.Screen); // We use prop added to global by reanimated since it seems safer than the one from RN. See:
