...
export declare const createRequest: <Data = any, Variables extends AnyVariables = AnyVariables>(q: string | DocumentNode | TypedDocumentNode<Data, Variables>, vars: Variables) => GraphQLRequest<Data, Variables>;
/**
